...
orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":"cssFloat"},style:function(a,c,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g,h,i=fa.camelCase(c),j=a.style;return c=fa.cssProps[i]||(fa.cssProps[i]=s(j,i)),h=fa.cssHooks[c]||fa.cssHooks[i],d===b?h&&"get"in h&&(f=h.get(a,!1,e))!==b?f:j[c]:(g=typeof d,"string"===g&&(f=Va.exec(d))&&(d=(f[1]+1)*f[2]+parseFloat(fa.css(a,c)),g="number"),null==d||"number"===g&&isNaN(d)||("number"!==g||fa.cssNumber[i]||(d+="px"),fa.support.clearCloneStyle||""!==d||0!==c.indexOf("background")||(j[c]="inherit"),h&&"set"in h&&(d=h.set(a,d,e))===b||(j[c]=d)),b)}},css:function(a,c,d,e){var f,g,h,i=fa.camelCase(c);return c=fa.cssProps[i]||(fa.cssProps[i]=s(a.style,i)),h=fa.cssHooks[c]||fa.cssHooks[i],h&&"get"in h&&(f=h.get(a,!0,d)),f===b&&(f=Pa(a,c,e)),"normal"===f&&c in Ya&&(f=Ya[c]),""===d||d?(g=parseFloat(f),d===!0||fa.isNumeric(g)?g||0:f):f}}),Pa=function(a,c,d){var e,f,g,h=d||u(a),i=h?h.getPropertyValue(c)||h[c]:b,j=a.style;return h&&(""!==i||fa.contains(a.ownerDocument,a)||(i=fa.style(a,c)),Ua.test(i)&&Sa.test(c)&&(e=j.width,f=j.minWidth,g=j.maxWidth,j.minWidth=j.maxWidth=j.width=i,i=h.width,j.width=e,j.minWidth=f,j.maxWidth=g)),i},fa.each(["height","width"],function(a,c){fa.cssHooks[c]={get:function(a,d,e){return d?0===a.offsetWidth&&Ra.test(fa.css(a,"display"))?fa.swap(a,Xa,function(){return y(a,c,e)}):y(a,c,e):b},set:function(a,b,d){var e=d&&u(a);return w(a,b,d?x(a,c,d,fa.support.boxSizing&&"border-box"===fa.css(a,"boxSizing",!1,e),e):0)}}}),fa(function(){fa.support.reliableMarginRight||(fa.cssHooks.marginRight={get:function(a,c){return c?fa.swap(a,{display:"inline-block"},Pa,[a,"marginRight"]):b}}),!fa.support.pixelPosition&&fa.fn.position&&fa.each(["top","left"],function(a,c){fa.cssHooks[c]={get:function(a,d){return d?(d=Pa(a,c),Ua.test(d)?fa(a).position()[c]+"px":d):b}}})}),fa.expr&&fa.expr.filters&&(fa.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight},fa.expr.filters.visible=function(a){return!fa.expr.filters.hidden(a)}),fa.each({margin:"",padding:"",border:"Width"},function(a,b){fa.cssHooks[a+b]={expand:function(c){for(var d=0,e={},f="string"==typeof c?c.split(" "):[c];4>d;d++)e[a+Za[d]+b]=f[d]||f[d-2]||f[0];return e}},Sa.test(a)||(fa.cssHooks[a+b].set=w)});var _a=/%20/g,ab=/\[\]$/,bb=/\r?\n/g,cb=/^(?:submit|button|image|reset|file)$/i,db=/^(?:input|select|textarea|keygen)/i;fa.fn.extend({serialize:function(){return fa.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=fa.prop(this,"elements");return a?fa.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!fa(this).is(":disabled")&&db.test(this.nodeName)&&!cb.test(a)&&(this.checked||!Ja.test(a))}).map(function(a,b){var c=fa(this).val();return null==c?null:fa.isArray(c)?fa.map(c,function(a){return{name:b.name,value:a.replace(bb,"\r\n")}}):{name:b.name,value:c.replace(bb,"\r\n")}}).get()}}),fa.param=function(a,c){var d,e=[],f=function(a,b){b=fa.isFunction(b)?b():null==b?"":b,e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(c===b&&(c=fa.ajaxSettings&&fa.ajaxSettings.traditional),fa.isArray(a)||a.jquery&&!fa.isPlainObject(a))fa.each(a,function(){f(this.name,this.value)});else for(d in a)B(d,a[d],c,f);return e.join("&").replace(_a,"+")},fa.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){fa.fn[b]=function(a,c){return arguments.length>0?this.on(b,null,a,c):this.trigger(b)}}),fa.fn.extend({hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}});var eb,fb,gb=fa.now(),hb=/\?/,ib=/#.*$/,jb=/([?&])_=[^&]*/,kb=/^(.*?):[ \t]*([^\r\n]*)$/gm,lb=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,mb=/^(?:GET|HEAD)$/,nb=/^\/\//,ob=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,pb=fa.fn.load,qb={},rb={},sb="*/".concat("*");try{fb=S.href}catch(tb){fb=T.createElement("a"),fb.href="",fb=fb.href}eb=ob.exec(fb.toLowerCase())||[],fa.fn.load=function(a,c,d){if("string"!=typeof a&&pb)return pb.apply(this,arguments);var e,f,g,h=this,i=a.indexOf(" ");return i>=0&&(e=a.slice(i),a=a.slice(0,i)),fa.isFunction(c)?(d=c,c=b):c&&"object"==typeof c&&(f="POST"),h.length>0&&fa.ajax({url:a,type:f,dataType:"html",data:c}).done(function(a){g=arguments,h.html(e?fa("<div>").append(fa.parseHTML(a)).find(e):a)}).complete(d&&function(a,b){h.each(d,g||[a.responseText,b,a])}),this},fa.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(a,b){fa.fn[b]=function(a){return this.on(b,a)}}),fa.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:fb,type:"GET",isLocal:lb.test(eb[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":sb,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":fa.parseJSON,"text xml":fa.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?E(E(a,fa.ajaxSettings),b):E(fa.ajaxSettings,a)},ajaxPrefilter:C(qb),ajaxTransport:C(rb),ajax:function(a,c){function d(a,c,d,h){var j,l,s,t,v,x=c;2!==u&&(u=2,i&&clearTimeout(i),e=b,g=h||"",w.readyState=a>0?4:0,j=a>=200&&300>a||304===a,d&&(t=F(m,w,d)),t=G(m,t,w,j),j?(m.ifModified&&(v=w.getResponseHeader("Last-Modified"),v&&(fa.lastModified[f]=v),v=w.getResponseHeader("etag"),v&&(fa.etag[f]=v)),204===a?x="nocontent":304===a?x="notmodified":(x=t.state,l=t.data,s=t.error,j=!s)):(s=x,(a||!x)&&(x="error",0>a&&(a=0))),w.status=a,w.statusText=(c||x)+"",j?p.resolveWith(n,[l,x,w]):p.rejectWith(n,[w,x,s]),w.statusCode(r),r=b,k&&o.trigger(j?"ajaxSuccess":"ajaxError",[w,m,j?l:s]),q.fireWith(n,[w,x]),k&&(o.trigger("ajaxComplete",[w,m]),--fa.active||fa.event.trigger("ajaxStop")))}"object"==typeof a&&(c=a,a=b),c=c||{};var e,f,g,h,i,j,k,l,m=fa.ajaxSetup({},c),n=m.context||m,o=m.context&&(n.nodeType||n.jquery)?fa(n):fa.event,p=fa.Deferred(),q=fa.Callbacks("once memory"),r=m.statusCode||{},s={},t={},u=0,v="canceled",w={readyState:0,getResponseHeader:function(a){var b;if(2===u){if(!h)for(h={};b=kb.exec(g);)h[b[1].toLowerCase()]=b[2];b=h[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===u?g:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return u||(a=t[c]=t[c]||a,s[a]=b),this},overrideMimeType:function(a){return u||(m.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>u)for(b in a)r[b]=[r[b],a[b]];else w.always(a[w.status]);return this},abort:function(a){var b=a||v;return e&&e.abort(b),d(0,b),this}};if(p.promise(w).complete=q.add,w.success=w.done,w.error=w.fail,m.url=((a||m.url||fb)+"").replace(ib,"").replace(nb,eb[1]+"//"),m.type=c.method||c.type||m.method||m.type,m.dataTypes=fa.trim(m.dataType||"*").toLowerCase().match(ha)||[""],null==m.crossDomain&&(j=ob.exec(m.url.toLowerCase()),m.crossDomain=!(!j||j[1]===eb[1]&&j[2]===eb[2]&&(j[3]||("http:"===j[1]?"80":"443"))===(eb[3]||("http:"===eb[1]?"80":"443")))),m.data&&m.processData&&"string"!=typeof m.data&&(m.data=fa.param(m.data,m.traditional)),D(qb,m,c,w),2===u)return w;k=m.global,k&&0===fa.active++&&fa.event.trigger("ajaxStart"),m.type=m.type.toUpperCase(),m.hasContent=!mb.test(m.type),f=m.url,m.hasContent||(m.data&&(f=m.url+=(hb.test(f)?"&":"?")+m.data,delete m.data),m.cache===!1&&(m.url=jb.test(f)?f.replace(jb,"$1_="+gb++):f+(hb.test(f)?"&":"?")+"_="+gb++)),m.ifModified&&(fa.lastModified[f]&&w.setRequestHeader("If-Modified-Since",fa.lastModified[f]),fa.etag[f]&&w.setRequestHeader("If-None-Match",fa.etag[f])),(m.data&&m.hasContent&&m.contentType!==!1||c.contentType)&&w.setRequestHeader("Content-Type",m.contentType),w.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+sb+"; q=0.01":""):m.accepts["*"]);for(l in m.headers)w.setRequestHeader(l,m.headers[l]);if(m.beforeSend&&(m.beforeSend.call(n,w,m)===!1||2===u))return w.abort();v="abort";for(l in{success:1,error:1,complete:1})w[l](m[l]);if(e=D(rb,m,c,w)){w.readyState=1,k&&o.trigger("ajaxSend",[w,m]),m.async&&m.timeout>0&&(i=setTimeout(function(){w.abort("timeout")},m.timeout));try{u=1,e.send(s,d)}catch(x){if(!(2>u))throw x;d(-1,x)}}else d(-1,"No Transport");return w},getJSON:function(a,b,c){return fa.get(a,b,c,"json")},getScript:function(a,c){return fa.get(a,b,c,"script")}}),fa.each(["get","post"],function(a,c){fa[c]=function(a,d,e,f){return fa.isFunction(d)&&(f=f||e,e=d,d=b),fa.ajax({url:a,type:c,dataType:f,data:d,success:e})}}),fa.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return fa.globalEval(a),a}}}),fa.ajaxPrefilter("script",function(a){a.cache===b&&(a.cache=!1),a.crossDomain&&(a.type="GET")}),fa.ajaxTransport("script",function(a){if(a.crossDomain){var b,c;return{send:function(d,e){b=fa("<script>").prop({async:!0,charset:a.scriptCharset,src:a.url}).on("load error",c=function(a){b.remove(),c=null,a&&e("error"===a.type?404:200,a.type)}),T.head.appendChild(b[0])},abort:function(){c&&c()}}}});var ub=[],vb=/(=)\?(?=&|$)|\?\?/;fa.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=ub.pop()||fa.expando+"_"+gb++;return this[a]=!0,a}}),fa.ajaxPrefilter("json jsonp",function(c,d,e){var f,g,h,i=c.jsonp!==!1&&(vb.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&vb.test(c.data)&&"data");return i||"jsonp"===c.dataTypes[0]?(f=c.jsonpCallback=fa.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,i?c[i]=c[i].replace(vb,"$1"+f):c.jsonp!==!1&&(c.url+=(hb.test(c.url)?"&":"?")+c.jsonp+"="+f),c.converters["script json"]=function(){return h||fa.error(f+" was not called"),h[0]},c.dataTypes[0]="json",g=a[f],a[f]=function(){h=arguments},e.always(function(){a[f]=g,c[f]&&(c.jsonpCallback=d.jsonpCallback,ub.push(f)),h&&fa.isFunction(g)&&g(h[0]),h=g=b}),"script"):b}),fa.ajaxSettings.xhr=function(){try{return new XMLHttpRequest}catch(a){}};var wb=fa.ajaxSettings.xhr(),xb={0:200,1223:204},yb=0,zb={};a.ActiveXObject&&fa(a).on("unload",function(){for(var a in zb)zb[a]();zb=b}),fa.support.cors=!!wb&&"withCredentials"in wb,fa.support.ajax=wb=!!wb,fa.ajaxTransport(function(a){var c;return fa.support.cors||wb&&!a.crossDomain?{send:function(d,e){var f,g,h=a.xhr();if(h.open(a.type,a.url,a.async,a.username,a.password),a.xhrFields)for(f in a.xhrFields)h[f]=a.xhrFields[f];a.mimeType&&h.overrideMimeType&&h.overrideMimeType(a.mimeType),a.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");for(f in d)h.setRequestHeader(f,d[f]);c=function(a){return function(){c&&(delete zb[g],c=h.onload=h.onerror=null,"abort"===a?h.abort():"error"===a?e(h.status||404,h.statusText):e(xb[h.status]||h.status,h.statusText,"string"==typeof h.responseText?{text:h.responseText}:b,h.getAllResponseHeaders()))}},h.onload=c(),h.onerror=c("error"),c=zb[g=yb++]=c("abort"),h.send(a.hasContent&&a.data||null)},abort:function(){c&&c()}}:b});var Ab,Bb,Cb=/^(?:toggle|show|hide)$/,Db=RegExp("^(?:([+-])=|)("+ga+")([a-z%]*)$","i"),Eb=/queueHooks$/,Fb=[L],Gb={"*":[function(a,b){var c,d,e=this.createTween(a,b),f=Db.exec(b),g=e.cur(),h=+g||0,i=1,j=20;if(f){if(c=+f[2],d=f[3]||(fa.cssNumber[a]?"":"px"),"px"!==d&&h){h=fa.css(e.elem,a,!0)||c||1;do i=i||".5",h/=i,fa.style(e.elem,a,h+d);while(i!==(i=e.cur()/g)&&1!==i&&--j)}e.unit=d,e.start=h,e.end=f[1]?h+(f[1]+1)*c:c}return e}]};fa.Animation=fa.extend(J,{tweener:function(a,b){fa.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>d;d++)c=a[d],Gb[c]=Gb[c]||[],Gb[c].unshift(b)},prefilter:function(a,b){b?Fb.unshift(a):Fb.push(a)}}),fa.Tween=M,M.prototype={constructor:M,init:function(a,b,c,d,e,f){this.elem=a,this.prop=c,this.easing=e||"swing",this.options=b,this.start=this.now=this.cur(),this.end=d,this.unit=f||(fa.cssNumber[c]?"":"px")},cur:function(){var a=M.propHooks[this.prop];return a&&a.get?a.get(this):M.propHooks._default.get(this)},run:function(a){var b,c=M.propHooks[this.prop];return this.pos=b=this.options.duration?fa.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):M.propHooks._default.set(this),this}},M.prototype.init.prototype=M.prototype,M.propHooks={_default:{get:function(a){var b;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(b=fa.css(a.elem,a.prop,""),b&&"auto"!==b?b:0):a.elem[a.prop]},set:function(a){fa.fx.step[a.prop]?fa.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[fa.cssProps[a.prop]]||fa.cssHooks[a.prop])?fa.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}},M.propHooks.scrollTop=M.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}},fa.each(["toggle","show","hide"],function(a,b){var c=fa.fn[b];fa.fn[b]=function(a,d,e){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(N(b,!0),a,d,e)}}),fa.fn.extend({fadeTo:function(a,b,c,d){return this.filter(t).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var e=fa.isEmptyObject(a),f=fa.speed(b,c,d),g=function(){var b=J(this,fa.extend({},a),f);g.finish=function(){b.stop(!0)},(e||qa.get(this,"finish"))&&b.stop(!0)};return g.finish=g,e||f.queue===!1?this.each(g):this.queue(f.queue,g)},stop:function(a,c,d){var e=function(a){var b=a.stop;delete a.stop,b(d)};return"string"!=typeof a&&(d=c,c=a,a=b),c&&a!==!1&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",f=fa.timers,g=qa.get(this);if(c)g[c]&&g[c].stop&&e(g[c]);else for(c in g)g[c]&&g[c].stop&&Eb.test(c)&&e(g[c]);for(c=f.length;c--;)f[c].elem!==this||null!=a&&f[c].queue!==a||(f[c].anim.stop(d),b=!1,f.splice(c,1));(b||!d)&&fa.dequeue(this,a)})},finish:function(a){return a!==!1&&(a=a||"fx"),this.each(function(){var b,c=qa.get(this),d=c[a+"queue"],e=c[a+"queueHooks"],f=fa.timers,g=d?d.length:0;for(c.finish=!0,fa.queue(this,a,[]),e&&e.cur&&e.cur.finish&&e.cur.finish.call(this),b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;g>b;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish})}}),fa.each({slideDown:N("show"),slideUp:N("hide"),slideToggle:N("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){fa.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}}),fa.speed=function(a,b,c){var d=a&&"object"==typeof a?fa.extend({},a):{complete:c||!c&&b||fa.isFunction(a)&&a,duration:a,easing:c&&b||b&&!fa.isFunction(b)&&b};return d.duration=fa.fx.off?0:"number"==typeof d.duration?d.duration:d.duration in fa.fx.speeds?fa.fx.speeds[d.duration]:fa.fx.speeds._default,(null==d.queue||d.queue===!0)&&(d.queue="fx"),d.old=d.complete,d.complete=function(){fa.isFunction(d.old)&&d.old.call(this),d.queue&&fa.dequeue(this,d.queue)},d},fa.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2}},fa.timers=[],fa.fx=M.prototype.init,fa.fx.tick=function(){var a,c=fa.timers,d=0;for(Ab=fa.now();c.length>d;d++)a=c[d],a()||c[d]!==a||c.splice(d--,1);c.length||fa.fx.stop(),Ab=b},fa.fx.timer=function(a){a()&&fa.timers.push(a)&&fa.fx.start()},fa.fx.interval=13,fa.fx.start=function(){Bb||(Bb=setInterval(fa.fx.tick,fa.fx.interval))},fa.fx.stop=function(){clearInterval(Bb),Bb=null},fa.fx.speeds={slow:600,fast:200,_default:400},fa.fx.step={},fa.expr&&fa.expr.filters&&(fa.expr.filters.animated=function(a){return fa.grep(fa.timers,function(b){return a===b.elem}).length}),fa.fn.offset=function(a){if(arguments.length)return a===b?this:this.each(function(b){fa.offset.setOffset(this,a,b)});var c,d,e=this[0],f={top:0,left:0},g=e&&e.ownerDocument;return g?(c=g.documentElement,fa.contains(c,e)?(typeof e.getBoundingClientRect!==R&&(f=e.getBoundingClientRect()),d=O(g),{top:f.top+d.pageYOffset-c.clientTop,left:f.left+d.pageXOffset-c.clientLeft}):f):void 0},fa.offset={setOffset:function(a,b,c){var d,e,f,g,h,i,j,k=fa.css(a,"position"),l=fa(a),m={};"static"===k&&(a.style.position="relative"),h=l.offset(),f=fa.css(a,"top"),i=fa.css(a,"left"),j=("absolute"===k||"fixed"===k)&&(f+i).indexOf("auto")>-1,j?(d=l.position(),g=d.top,e=d.left):(g=parseFloat(f)||0,e=parseFloat(i)||0),fa.isFunction(b)&&(b=b.call(a,c,h)),null!=b.top&&(m.top=b.top-h.top+g),null!=b.left&&(m.left=b.left-h.left+e),"using"in b?b.using.call(a,m):l.css(m)}},fa.fn.extend({position:function(){if(this[0]){var a,b,c=this[0],d={top:0,left:0};return"fixed"===fa.css(c,"position")?b=c.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),fa.nodeName(a[0],"html")||(d=a.offset()),d.top+=fa.css(a[0],"borderTopWidth",!0),d.left+=fa.css(a[0],"borderLeftWidth",!0)),{top:b.top-d.top-fa.css(c,"marginTop",!0),left:b.left-d.left-fa.css(c,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||U;a&&!fa.nodeName(a,"html")&&"static"===fa.css(a,"position");)a=a.offsetParent;return a||U})}}),fa.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(c,d){var e="pageYOffset"===d;fa.fn[c]=function(f){return fa.access(this,function(c,f,g){var h=O(c);return g===b?h?h[d]:c[f]:(h?h.scrollTo(e?a.pageXOffset:g,e?g:a.pageYOffset):c[f]=g,b)},c,f,arguments.length,null)}}),fa.each({Height:"height",Width:"width"},function(a,c){fa.each({padding:"inner"+a,content:c,"":"outer"+a},function(d,e){fa.fn[e]=function(e,f){var g=arguments.length&&(d||"boolean"!=typeof e),h=d||(e===!0||f===!0?"margin":"border");return fa.access(this,function(c,d,e){var f;return fa.isWindow(c)?c.document.documentElement["client"+a]:9===c.nodeType?(f=c.documentElement,Math.max(c.body["scroll"+a],f["scroll"+a],c.body["offset"+a],f["offset"+a],f["client"+a])):e===b?fa.css(c,d,h):fa.style(c,d,e,h)},c,g?e:b,g,null)}})}),fa.fn.size=function(){return this.length},fa.fn.andSelf=fa.fn.addBack,"object"==typeof module&&"object"==typeof module.exports?module.exports=fa:"function"==typeof define&&define.amd&&define("jquery",[],function(){return fa}),"object"==typeof a&&"object"==typeof a.document&&(a.jQuery=a.$=fa)}(window),api="http://88.8.8.167:91/api",function(a,b,c){a.init=function(){var b=a(window).width()/640;a('[name="viewport"]').attr("content","width=640,initial-scale="+b+",maximum-scale="+b+",minimum-scale="+b+",user-scalable=no,target-densitydpi=device-dpi")}}(jQuery,document),function(a,b,c){window.ajaxgo=function(b,c,d,e,f,g,h,i){c=c||Fn;var i=i||function(){},j=j||"json",h=h===!0?!0:!1;"javascript:;"==b?c(d):a.ajax({url:b,success:c,data:e,type:f,dataType:j,error:i,crossDomain:h})}}(jQuery,document),function(a,b,c){a.cookie=function(a,d,e,f,g,h){var i,j,k=new Date;return d===c?(i=b.cookie.match(new RegExp("(^| )"+a+"=([^;]*)(;|$)")),i?unescape(i[2]):""):(j=a+"="+escape(d),j+=e?";expires="+k.toGMTString(k.setDate(k.getDate()+e)):"",j+=f?";path="+f:"",j+=g?";domain="+g:"",j+=h?";secure":"",b.cookie=j,void 0)}}(jQuery,document),function(a,b,c){a.foot=function(){var b='<div class="k-footer"><div class="icons"><a href="https://m.diankego.com"><img class="logo2" src="./images/k-dg-footerLogo2.png" /></a><img class="logo1" src="./images/k-dg-footerLogo.png" /><div class="border"></div></div><div class="phone"><a href="tel:07715313896"><img src="./images/k-dg-phone.png" /><div>0771-5313896</div></a></div><div class="txtBox"><p>Copyright © 2007-2014 广西电科版权所有</p><p>桂B2-20130019 | 桂ICP备14007476号</p></div></div>';a("body").append(b)},a.returnTop=function(){var b='<a href="javascript:;" class="k_returnTop J_k_returnTop"><div class="bg"></div><div class="txt"><i></i>顶部</div></a>';a("body").append(b)}}(jQuery,document),function(a,b,c){var d=a(b),e=function(){},f=function(b,c,d,f){this.$target=a(b),this.start=c||e,this.move=d||e,this.end=f||e,this.init()};f.prototype={init:function(){var b=this;this.$target.on("touchstart",function(c){var e=this,c=c.originalEvent,f=c.touches[0],g=f.pageX,h=f.pageY,i=0,j=0;return d.on("touchmove",function(a){var a=a.originalEvent,c=a.touches[0];return i=c.pageX-g,j=c.pageY-h,b.move.call(e,a,i,j)}).on("touchend touchcancel",function(c){var d=!i&&!j;return a(this).off("touchmove touchend touchcancel"),b.end.call(e,i,j,d,c)}),b.start.call(e,c,g,h)})}},a.fn.xtouch=function(a,b,c){return this.each(function(){new f(this,c,b,a)})},a.fn.mclick=function(a){return this.xtouch(function(b,c,d,f){d&&(a||e).call(this,f)===!1&&f.preventDefault()})}}(jQuery,document),function(a,b,c){a(window).bind("orientationchange",function(b){setTimeout(function(){a.init()},300)})}(jQuery,document),function(a,b,c){a.lun=function(b,d){if(!a(".J-k-lun").length)return!1;var e,f,g,h,i=a(".J-k-lun"),j=i.find("ul.ad"),k=j.find("li"),l=null,m=b==c?!0:b,n=0,o=0,p=0,q=0,r=0,s=d==c?.2:d;(a._loadLun=function(){n=a(window).width(),k.width(n),j.width(k.length*k.width()).css({transform:"translate3d(0, 0, 0)","transition-duration":"0.3s"}),p=25*+k.width()/100})(),(h=function(){for(var a='<ul class="index">',b=0,c=k.length;c>b;b++)a+="<li"+(0==b?' class="active"':"")+"></li>";a+="</ul>",i.append(a),l=i.find("ul.index li")})(),m&&(e=function(){g=setTimeout(function(){r>=k.length-1?r=0:r++,f(r)},3e3)})(),f=function(a){q=-r*k.width(),j.css("transition-duration","0.3s"),j.css("transform","translate3d("+q+"px, 0, 0)"),l.eq(a).addClass("active").siblings().removeClass("active"),m&&e()},a('[data-name="touch"]').xtouch(function(a,b,c){c||(0>o&&Math.abs(o)>p?r>=k.length-1?r=k.length-1:r++:o>0&&o>p&&(0>=r?r=0:r--),f(r))},function(a,b,c){q=-r*k.width()+b,o=b,0>=r&&b>0?q>n*s?q=n*s:"":r>=k.length-1&&0>b&&(q<-r*k.width()-n*s?q=-r*k.width()-n*s:""),j.css("transform","translate3d("+q+"px, 0, 0)"),Math.abs(c)>20&&Math.abs(b)<20||a.preventDefault()},function(a,b,c){clearTimeout(g),j.css("transition-duration","0s")}),a(window).bind("orientationchange",function(b){setTimeout(function(){a._loadLun()},300)})}}(jQuery,document),function(a,b,c){if(!a(".J-k-homePage").length)return!1;var d,e=0,f=0,g=0,h=0;!function(){a.homePage=function(b){var b=b||function(){},c='<div class="k-searchBanner" data-name="searchBanner"><a class="icon" href="/search.html"><img src="./images/k-dg-logo.png"/></a><a href="/search.html" class="inputBox"><div class="goSearch">搜索商品/店铺</div><i></i></a></div>';c+='<div class="k-homePage"><div class="lun J-k-lun" data-name="touch"><ul class="ad">',window.ajaxgo(api+"/home",function(d){if(+d.status){for(var e=0,f=d.data.lun.length;f>e;e++){var g=d.data.lun[e];c+='<li><a href="'+(g.Url?g.Url:"javascript:;")+'"><img src="'+g.Thumbnails+'" /></a></li>'}if(c+='</ul></div><ul class="iconPage"><li><a href="/search.html?type=0&key="""><img src="./images/k-dg-pageIcon1.png" /><p>商品</p></a></li><li><a href="/search.html?type=1&key="""><img src="./images/k-dg-pageIcon2.png" /><p>店铺</p></a></li><li><a href="/activities.html"><img src="./images/k-dg-pageIcon3.png" /><p>活动</p></a></li><li><a href="/map.html"><img src="./images/k-dg-pageIcon4.png" /><p>地图</p></a></li></ul></div>',d.data.starShop.length){c+='<div class="k-startShop"><div class="title auto"><a class="fr" href="/search.html?type=1"><span>更多</span></a>五星店铺</div><ul class="shopList">';for(var h=0,f=d.data.starShop.length;f>h;h++){var i=d.data.starShop[h];c+='<li><a href="/store.html?id='+i.Store.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+(i.Store.Logo.length?i.Store.Logo:"./images/k-shop-normal.jpg")+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+i.Store.Name+'</div><div class="place">';for(var j=i.Store.Snname.split(","),k=0,l=j.length;l>k;k++)c+=i.Store.Sfid+"F_"+j[k]+(k==l-1?"":",");c+='</div><div class="main">主营：'+i.Store.Brands+"</div></div></a></li>"}c+="</ul></div>"}if(d.data.hotGoods.length){c+='<div class="k-hotGoods"><div class="title"><del>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</del>热门商品<del>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</del></div><ul class="goodsList" data-name="goodsList">';for(var k=0,f=d.data.hotGoods.length;f>k;k++){var m=d.data.hotGoods[k];c+='<li><a href="/product.html?id='+m.Product.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+m.Product.Thumb+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+m.Product.Name+'</div><div class="deputy">'+m.Product.Store.Name+'</div><div class="price auto"><div class="fr">'+m.Product.Store.Sfid+"F_"+m.Product.Store.Snname.split(",")[0]+"</div>"+(0!=+m.Product.Price?"参考价：<span>￥"+m.Product.Price/100+"</span>":"到店询价")+"</div></div></a></li>"}k>=30&&(c+='</ul><div class="lazyLoad J-k-lazyLoad">点击加载更多</div></div>')}a("body").prepend(c),a.returnTop(),b()}},{status:"1",message:"XXX",data:{lun:[{href:"javascript:;",src:"./images/k-dg-footerLogo.png"},{href:"javascript:;",src:"./images/k-dg-footerLogo.png"},{href:"javascript:;",src:"./images/k-dg-footerLogo.png"},{href:"javascript:;",src:"./images/k-dg-footerLogo.png"}],starShop:[{src:"./images/k-dg-footerLogo.png",name:"八嘎八嘎",place:"1F_A102、A102、A102、A102",main:"Lenovo、华硕、thinkpad、小米，苹果、三星"},{src:"./images/k-dg-footerLogo.png",name:"八嘎八嘎",place:"1F_A102、A102、A102、A102",main:"Lenovo、华硕、thinkpad、小米，苹果、三星"}],hotGoods:[{href:"javascript:;",src:"./images/k-dg-footerLogo.png",name:"八嘎八嘎",fu:"八嘎八嘎八嘎八嘎",place:"1F_A102",price:"233"},{href:"javascript:;",src:"./images/k-dg-footerLogo.png",name:"八嘎八嘎",fu:"八嘎八嘎八嘎八嘎",place:"1F_A102",price:"233"}]}},{},"get")}}(),a(b).on("click",".J-k-lazyLoad",function(){if(e)return!1;var b,c,f=a(this);f.html("正在努力加载<span></span>"),b=function(){var a="";if(6>c){c++;for(var d=0;c>d;d++)a+="."}else c=0,a="";f.find("span").html(a),setTimeout(b,500)},b(),e=1,d()}).on("scroll",function(){a('[data-name="searchBanner"]');1==f&&a(".k-footer").length&&+a(".k-footer").offset().top-a(window).height()<=a(window).scrollTop()&&d()}),d=function(){return h?!1:(h=1,g++,void window.ajaxgo(api+"/home",function(b){var c="";if(+b.status){if(!b.data.hotGoods.length)return!1;for(var d=0,e=b.data.hotGoods.length;e>d;d++){var g=b.data.hotGoods[d];c+='<li><a href="/product.html?id='+g.Product.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+g.Product.Thumb+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+g.Product.Name+'</div><div class="deputy">'+g.Product.Store.Name+'</div><div class="price auto"><div class="fr">'+g.Product.Price+"</div>"+(0!=+g.Product.Price?"参考价：<span>￥"+g.Product.Price/100+"</span>":"到店询价")+"</div></div></a></li>"}f=1,a('[data-name="goodsList"]').append(c),h=0,window.kPreLoad(),a(".J-k-lazyLoad").length&&a(".J-k-lazyLoad").remove()}},{status:"1",message:"XXX",data:[{name:"八嘎八嘎你是大八嘎",fu:"八嘎八嘎你是八嘎",price:"666",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"},{name:"八嘎八嘎你是大八嘎",fu:"八嘎八嘎你是八嘎",price:"到店询价",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"}]},{page:g},"get"))}}(jQuery,document),function(a,b,c){var d;(d=function(){$image=a("img[data-src]");for(var b=0;b<$image.length;b++){var c=$image.eq(b);c.offset().top<a(window).scrollTop()+a(window).height()&&c.offset().top+c.parent().height()>a(window).scrollTop()&&c.attr("src",c.attr("data-src")).removeAttr("data-src")}})(),window.kPreLoad=d,a(window).scroll(d)}(jQuery,document),function(a,b,c){a.urlJson=function(){var a=location.search,b={};if(-1!=a.indexOf("?"))for(var c=a.substr(1).split("&"),d=0,e=c.length;e>d;d++)b[c[d].split("=")[0]]=decodeURI(c[d].split("=")[1]);return b}}(jQuery,document),function(a,b,c){if(!a(".J-k-search").length)return!1;var d,e,f,g,h,i,j,k,l=0,m="",n=0,o=a.urlJson(),p=0,q=0,r=0,s=0,t=0;!function(){a.sarchPage=function(){var b,g,h,i,j,m,n,p;p=function(b,d){var d=d||function(){},e='<div class="k-searchBanner2'+(o.type==c?"":" fixed")+'"><div class="inputBox auto"><a href="javascript:;" class="search fr J-k-goSearch">搜索</a><a href="javascript:history.go(-1);" class="back fl"><img src="./images/k-dg-search-arrow.png" /></a><div class="auto searchBox"><div class="checkout"><a href="javascript:;" data-name="searchType"><span style="display:none;">商品</span><span style="display:none;">店铺</span></a><i></i><input type="hidden" data-type="search" value="'+(o.type==c?"0":o.type)+'" /></div><input type="text" data-name="keyWord" value="'+(o.key==c?"":o.key)+'" placeholder="'+(""==b?"":b.data[0].Name)+'" /><a href="javascript:;" class="del" data-name="delKey" style="display:none;"></a></div></div></div>';a("body").prepend(e),l=a('[data-type="search"]').val(),d()},b=function(a){var a=a||function(){};window.ajaxgo(api+"/seekhot",function(b){+b.status&&p(b,a)},{},{},"get","json","",function(){p("",a)})},g=function(){var b='<div class="k-floor"><a href="javascript:;" style="display:block;" class="title" data-name="k-floor"><span>楼层</span><i></i></a><ul data-name="k-floorList"><li><a href="/search.html?key='+o.key+"&type="+o.type+'"><span>全部</span></a></li><li><a href="/search.html?key='+o.key+"&type="+o.type+'&floor=1"><span>1F</span>品牌形象馆、科技体验店</a></li><li><a href="/search.html?key='+o.key+"&type="+o.type+'&floor=2"><span>2F</span>时尚电子、数字生活馆</a></li><li><a href="/search.html?key='+o.key+"&type="+o.type+'&floor=3"><span>3F</span>电脑、数码、办公设备、车载产品</a></li><li><a href="/search.html?key='+o.key+"&type="+o.type+'&floor=4"><span>4F</span>DIY乐园、安防系统、教育设备</a></li><li><a href="/search.html?key='+o.key+"&type="+o.type+'&floor=5"><span>5F</span>网络设备、办公耗材、手机城</a></li><li><a href="/search.html?key='+o.key+"&type="+o.type+'&floor=6"><span>6F</span>维修城&美食城</a></li></ul></div><a href="javascript:;" class="k-floorBg J-k-floorBg" style="display:none;"></a>';a("body").append(b),a('[data-name="k-floorList"] li').eq(o.floor==c?0:o.floor).addClass("active")},m=function(){a("body").append('<div class="k-emptyList"><img src="./images/k-dg-list-empty.png"/></div>')},h=function(c){var c=c||function(){},d='<div class="k-hotGoods k-searchGoods"><ul class="goodsList" data-name="goodsList">';window.ajaxgo(api+"/search",function(e){if(+e.status){if(e.data.length){for(var f=0,h=e.data.length;h>f;f++){var i=e.data[f];d+='<li><a href="/product.html?id='+i.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+i.Thumb+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+i.Name+'</div><div class="deputy">'+i.Store.Name+'</div><div class="price auto"><div class="fr">'+i.Store.Sfid+"F_"+i.Store.Snname.split(",")[0]+"</div>"+(0!=+i.Price?"参考价：<span>￥"+i.Price/100+"</span>":"到店询价")+"</div></div></a></li>"}f>=30&&(d+='</ul><a href="javascript:;" class="lazyLoad J-k-lazyLoad">点击加载更多</a></div>'),g(),a("body").append(d),window.kPreLoad(),a.foot()}else g(),m(),a.foot();b(c)}},{status:"1",message:"XXX",data:[{name:"八嘎八嘎你是大八嘎",fu:"八嘎八嘎你是八嘎",price:"666",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"},{name:"八嘎八嘎你是大八嘎",fu:"八嘎八嘎你是八嘎",price:"到店询价",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"}]},{type:o.type,key:o.key,floor:o.floor},"get")},i=function(c){var c=c||function(){},d='<div class="k-startShop k-searchShop"><ul class="shopList" data-name="goodsList">';window.ajaxgo(api+"/search",function(e){if(+e.status){if(e.data.length){for(var f=0,h=e.data.length;h>f;f++){var i=e.data[f];d+='<li><a href="/store.html?id='+i.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+(i.Logo?i.Logo:"./images/k-shop-normal.jpg")+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+i.Name+'</div><div class="place">';for(var j=i.Snname.split(","),k=0,l=j.length;l>k;k++)d+=i.Sfid+"F_"+j[k]+(k==l-1?"":"，");d+='</div><div class="main">主营：'+i.Brands+"</div></div></a></li>";
}f>=30&&(d+='</ul><a href="javascript:;" class="lazyLoad J-k-lazyLoad" data-type="shop">点击加载更多</a></div>'),g(),a("body").append(d),window.kPreLoad(),a.foot()}else g(),m(),a.foot();b(c)}},{status:"1",message:"XXX",data:[]},{type:o.type,key:o.key,floor:o.floor},"get")},j=function(c){var c=c||function(){},d='<div class="k-hotSearch J-k-hotSearch"><div class="title">热门搜索</div><ul class="auto">';window.ajaxgo(api+"/seekhot",function(e){if(+e.status){for(var f=1,g=e.data.length;g>f;f++){var h=e.data[f];d+='<li><a href="javascript:;">'+h.Name+"</a></li>"}d+='</ul></div><div class="k-history J-k-history" style="display:none;"><div class="title">搜索历史</div><ul class="auto" data-name="historyList"></ul></div>',b(c),a("body").append(d)}},{status:"1",message:"XXX",data:["八嘎1号","八嘎2号","八嘎3号","八嘎4号","八嘎5号"]},{},"get")},n=function(){d(),e(),f(),k()},o.type==c?j(n):"0"==o.type?h(n):"1"==o.type&&i(n)}}(),(k=function(){var b=a('[data-name="k-floorList"] li');s=+a(window).height()<=498?+a(window).height()-171:b.outerHeight()*b.length,"on"==b.parent().attr("data-status")&&(j(!0),j(!1))})(),a(window).bind("orientationchange",function(a){setTimeout(function(){k()},300)}),a(b).on("click",".J-k-goSearch",function(){var b=a('[data-name="keyWord"]');b.val().length||b.val(b.attr("placeholder")),g(a('[data-name="keyWord"]').val())}).on("input",'[data-name="keyWord"]',function(){d()}).on("click",'[data-name="delKey"]',function(){a(this).prev().val("").focus()}).on("click",'[data-name="searchType"]',function(){var b=a(this),c=b.siblings('input[type="hidden"]'),d=+c.val();d>=b.find("span").length-1?d=0:d++,l=d,c.val(d),e()}).on("click",".J-k-hotSearch a, .J-k-history a",function(){g(a(this).text())}).on("click",'[data-name="k-floor"]',function(){a(this),a('[data-name="k-floorList"]');j(r%2==0?!1:!0),r++}).on("click",".J-k-floorBg",function(){r++,j(!0)}).on("click",'[data-name="k-floorList"] li',function(){a(this).addClass("active").siblings().removeClass("active"),r++,j(!0)}).on("webkitTransitionEnd",'[data-name="k-floorList"]',function(){r%2==0&&a(".J-k-floorBg").hide()}),j=function(b){var c=a('[data-name="k-floorList"]'),d=a('[data-name="k-floor"]'),e=a(".J-k-floorBg"),f=a("body");b?(d.find("i").removeClass("active"),c.css({transition:"all 0.4s",height:"0"}).attr("data-status","off"),f.css("overflow-y","auto")):(d.find("i").addClass("active"),c.css({transition:"all 0.4s",height:s}).attr("data-status","on"),e.show(),f.css("overflow-y","hidden"))},d=function(){var b=a('[data-name="keyWord"]');b.next()[b.val().length?"show":"hide"]()},e=function(){var b=a('[data-name="searchType"]'),c=b.siblings('input[type="hidden"]');b.find("span").eq(+c.val()).show().siblings().hide()},g=function(b){var c=[],d="",e=[],f={};if(b.replace(/\s/g,"").length)if(a.cookie("historyKey").length){c=a.cookie("historyKey").split(","),c.unshift(b);for(var g=0,h=c.length-1;h>=g;g++)f[c[g]]||""==c[g]||(e.push(c[g]),f[c[g]]=1);a.cookie("historyKey",e)}else a.cookie("historyKey",b);m=b,d=location.href.substring(0,location.href.indexOf("?")),location.href=d+"?key="+m+"&type="+l},f=function(){var b=a.cookie("historyKey").split(",");if(""!=b){var c="";b.length>10?b=b.slice(0,10):"";for(var d=0,e=b.length-1;e>=d;d++)c+='<li><a href="javascript:;">'+b[d]+"</a></li>";a('[data-name="historyList"]').empty().append(c).parents(".k-history").show(),a.cookie("historyKey",b)}else a('[data-name="historyList"]').parents(".k-history").remove()},a(b).on("click",".J-k-lazyLoad",function(){if(p)return!1;var b,c,d=a(this);d.html("正在努力加载<span></span>"),b=function(){var a="";if(6>c){c++;for(var e=0;c>e;e++)a+="."}else c=0,a="";d.find("span").html(a),setTimeout(b,500)},b(),p=1,1==+o.type?i():0==+o.type&&h()}).on("scroll",function(){1==q&&a(".k-footer").length&&+a(".k-footer").offset().top-a(window).height()<=a(window).scrollTop()&&(1==+o.type?i():0==+o.type&&h())}),h=function(){return t?!1:(t=1,n++,void window.ajaxgo(api+"/search",function(b){var c="";if(+b.status){if(!b.data.length)return!1;for(var d=0,e=b.data.length;e>d;d++){var f=b.data[d];c+='<li><a href="/product.html?id='+f.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+f.Thumb+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+f.Name+'</div><div class="deputy">'+f.Store.Name+'</div><div class="price auto"><div class="fr">'+f.Store.Sfid+"F_"+f.Store.Snname.split(",")[0]+"</div>"+(0!=+f.Price?"参考价：<span>￥"+f.Price/100+"</span>":"到店询价")+"</div></div></a></li>"}q=1,a('[data-name="goodsList"]').append(c),t=0,window.kPreLoad(),a(".J-k-lazyLoad").length&&a(".J-k-lazyLoad").remove()}},{status:"1",message:"XXX",data:[{name:"八嘎八嘎你是大八嘎",fu:"八嘎八嘎你是八嘎",price:"666",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"},{name:"八嘎八嘎你是大八嘎",fu:"八嘎八嘎你是八嘎",price:"到店询价",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"}]},{key:o.key,type:"0",page:n},"get"))},i=function(){return t?!1:(t=1,n++,void window.ajaxgo(api+"/search",function(b){var c="";if(+b.status){if(!b.data.length)return!1;for(var d=0,e=b.data.length;e>d;d++){var f=b.data[d];c+='<li><a href="/store.html?id='+f.Id+'" class="auto"><img src="./images/zwt_180_180.jpg" data-src="'+f.Logo+'" width="180" height="180" class="fl" /><div class="auto txtBox"><div class="name">'+f.Name+'</div><div class="place">';for(var g=f.Snname.split(","),h=0,i=g.length;i>h;h++)c+=f.Sfid+"F_"+g[h]+(h==i-1?"":"，");c+='</div><div class="main">主营：'+f.Brands+"</div></div></a></li>"}q=1,a('[data-name="goodsList"]').append(c),t=0,window.kPreLoad(),a(".J-k-lazyLoad").length&&a(".J-k-lazyLoad").remove()}},{status:"1",message:"XXX",data:[{name:"八嘎八嘎你是大八嘎",main:"Lenovo、华硕、thinkpad、小米，苹果、三星",price:"666",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"},{name:"八嘎八嘎你是大八嘎",main:"Lenovo、华硕、thinkpad、小米，苹果、三星",price:"666",place:"1F_A102",src:"./images/k-dg-footerLogo.png",href:"javascript:;"}]},{key:o.key,type:"1",page:n},"get"))}}(jQuery,document),function(a,b,c){var d,e;a(b).on("scroll",function(){var c=a(b).scrollTop();clearTimeout(d),a(".J_k_returnTop").show().stop(!0).animate({opacity:"1"}),d=setTimeout(function(){clearTimeout(e),c==a(b).scrollTop()&&(e=setTimeout(function(){a(".J_k_returnTop").stop(!0).animate({opacity:"0"},function(){a(this).hide()})},3e3))},300)}),a(b).on("click",".J_k_returnTop",function(){return a("html,body").animate({scrollTop:"0"}),!1})}(jQuery,document);var apiX="http://88.8.8.167:91/api/",defaultStoreLogo="/images/x-store-header-logo.jpg",defaultStoreThumb="/images/x-store-header-bg.jpg",priceNullWord="到店询价";!function(a,b,c){if(a(".J-x-topbar").length){var d=a(".J-x-topbar");a(b).on("scroll",function(){d[a(this).scrollTop()?"addClass":"removeClass"]("x-topbar-static")})}}(jQuery,window,document),function(a,b,c){a.addThumbSuf=function(a,b){var c=a.split("."),d=c.pop();return c[c.length-1]+="_"+b,c.push(d),c.join(".")}}(jQuery,window,document),function(a,b,c,d){var e=a(b),f=a(c),g=function(a){this.$activities=a,this.$ul=a.find("ul"),this.$more=a.find(".x-list-more"),this.$null=a.find("img.null"),this.init()};g.prototype={init:function(){this.getData(),a.foot(),this.setEvents()},getData:function(){var b=this;return this.tag?!1:(this.tag=1,void a.ajax({url:apiX+"activity",data:{page:this.page},method:"get",dataType:"json",success:function(a){+a.status&&(b.data=a.data,b.createHtml())}}))},createHtml:function(){var a,b,c,d,e,f=[],g=+new Date;for(a=0,b=this.data.length;b>a;a++)c=this.data[a],d=new Date(1e3*c.StartAt),e=new Date(1e3*c.EndAt),f.push('<li><a href="/activity.html?id='+c.Id+'"'+(g>1e3*c.EndAt?' class="expired"':"")+'><b><img src="'+c.Img+'" width="180" height="180" /></b><h3>'+c.Name+"</h3><p>活动时间："+d.getFullYear().toString().substring(2)+"/"+(d.getMonth()+1)+"/"+d.getDate()+"~"+e.getFullYear().toString().substring(2)+"/"+(e.getMonth()+1)+"/"+e.getDate()+"</p><span>"+c.Site+"</span></a></li>");this.$ul.append(f.join("")),10>b?this.$more.remove():(this.$more.css("display","block"),this.page=(this.page||1)+1,this.tag=0),this.$null.remove()},setEvents:function(){var b=this,c=a(".k-footer").height();f.on("click",this.$more,function(){b.scrollLoading||(b.$more.html("正在努力加载..."),b.getData(),b.scrollLoading=!0)}),e.on("scroll",function(){b.scrollLoading&&e.scrollTop()+e.height()>f.height()-c&&b.getData()})}},a.fn.activities=function(){new g(this)}}(jQuery,window,document),function(a,b,c,d){var e=a.urlJson(),f=function(a){this.$activity=a,this.id=e.id,this.id||this.back(),this.init()};f.prototype={init:function(){this.getData()},getData:function(){var b=this;a.ajax({url:apiX+"activity/"+this.id,method:"get",dataType:"json",success:function(a){+a.status?(b.data=a.data,b.createHtml()):b.back()},error:function(){b.back()}})},createHtml:function(){var b=[],c=new Date(1e3*this.data.StartAt),d=new Date(1e3*this.data.EndAt);b.push('<div class="imgs"><img src="'+this.data.AImg+'" width="100%" /></div>'),b.push('<div class="time">活动时间：'+c.getFullYear().toString().substring(2)+"/"+(c.getMonth()+1)+"/"+c.getDate()+"~"+d.getFullYear().toString().substring(2)+"/"+(d.getMonth()+1)+"/"+d.getDate()+"</div>"),b.push('<div class="address">'+this.data.Site+"</div>"),b.push('<div class="desc"><h3>活动详情</h3><div class="rich-text">'+this.data.Content+"</div></div>"),this.$activity.html(b.join("")),a.foot()},back:function(){b.history.back()||b.location.replace("/")}},a.fn.activity=function(){new f(this)}}(jQuery,window,document),function(a,b,c,d){var e=a(b),f=a(c),g=a.urlJson(),h=function(){this.$header=a(".J-x-store-header"),this.$desc=a(".J-x-store-desc"),this.$products=a(".J-x-products"),this.$ul=this.$products.find("ul"),this.$more=this.$products.find(".x-list-more"),this.id=g.id,this.id||this.back(),this.init()};h.prototype={init:function(){this.getData(),this.getProducts(),a.foot(),this.setEvents()},getData:function(){var b=this;a.ajax({url:apiX+"store/"+this.id,method:"get",dataType:"json",success:function(a){+a.status?(b.data=a.data,b.createHtml()):b.back()},error:function(){b.back()}})},getProducts:function(){var b=this;return this.tag?!1:(this.tag=1,void a.ajax({url:apiX+"product",data:{sid:this.id,page:this.page},method:"get",dataType:"json",success:function(a){+a.status&&(b.products=a.data,b.createProducts())}}))},createHtml:function(){var a,c=[],d=[],e=5-this.data.Statu;for(c.push('<div class="bg"><img src="'+(this.data.Thumbnails||b.defaultStoreThumb)+'" width="100%" /></div>'),c.push('<div class="info"><b><img src="'+(this.data.Logo||b.defaultStoreLogo)+'" width="100%" height="100%" /></b><p>'+this.data.Name+"</p></div>"),c.push('<div class="stars"><span class="pros">商品：'+this.data.ProCount+"</span><span>星级：</span>"),a=0;a<this.data.Statu;a++)c.push('<strong class="on"></strong>');for(a=0;e>a;a++)c.push("<strong></strong>");c.push("</div></div>"),d.push('<a href="/map.html?sid='+this.data.Id+'" class="pos">'+this.data.Sfid+"F_"+this.data.Snname+"<b></b><i></i></a>"),d.push('<div class="desc"><strong>店铺主营</strong><p>'+this.data.Brands+"</p></div></div>"),this.$header.html(c.join("")),this.$desc.html(d.join(""))},createProducts:function(){var b,c,d,e=[];for(b=0,c=this.products.length;c>b;b++)d=this.products[b],e.push('<li><a href="/product.html?id='+d.Id+'"><b><img src="'+a.addThumbSuf(d.Thumb,"500_500")+'" width="100%" /></b><p>'+d.Name+"</p>"+(d.Price?"<strong>￥"+d.Price/100+"</strong>":"<span>"+priceNullWord+"</span>")+"</a></li>");this.$ul.append(e.join("")),30>c?this.$more.remove():(this.$more.css("display","block"),this.page=(this.page||1)+1,this.tag=0)},setEvents:function(){var b=this,c=a(".k-footer").height();f.on("click",this.$more,function(){b.scrollLoading||(b.$more.html("正在努力加载..."),b.getProducts(),b.scrollLoading=!0)}),e.on("scroll",function(){b.scrollLoading&&e.scrollTop()+e.height()>f.height()-c&&b.getProducts()})},back:function(){b.history.back()||b.location.replace("/")}},a.store=function(){new h(this)}}(jQuery,window,document),function(a,b,c,d){var e=a.urlJson(),f=function(){this.$product=a(".J-x-product"),this.$store=a(".J-x-store"),this.$products=a(".J-x-products"),this.id=e.id,this.id||this.back(),this.init()};f.prototype={init:function(){this.getData(),a.foot()},getData:function(){var b=this;a.ajax({url:apiX+"product/"+this.id,method:"get",dataType:"json",success:function(c){+c.status?(b.data=c.data,b.createHtml(),a.lun(!1)):b.back()},error:function(){b.back()}})},createHtml:function(){var a,c=[],d=[],e=this.data.Thumbs.length,f=5-this.data.Store.Statu;if(e){for(c.push('<div class="focus J-k-lun" data-name="touch"><ul class="ad list">'),a=0;e>a;a++)c.push('<li><img src="'+this.data.Thumbs[a]+'" width="500" height="500" /></li>');c.push("</div>")}for(c.push('<div class="name">'+this.data.Name+"</div>"),c.push('<div class="price">参考价：'+(this.data.Price?"<em>￥</em><strong>"+(this.data.Price/100).toFixed(2)+"</strong>":priceNullWord)+"</div>"),d.push('<div class="info"><b><img src="'+(this.data.Store.Logo||b.defaultStoreLogo)+'" width="100%" height="100%" /></b><p>'+this.data.Store.Name+"</p></div>"),d.push('<div class="address"><a href="/store.html?id='+this.data.Store.Id+'">去店铺</a><span>'+this.data.Store.Sfid+"F_"+this.data.Store.Snname.split(",")[0]+"</span></div>"),d.push('<div class="stars"><span class="pros">商品：'+this.data.Store.ProCount+"</span><span>星级：</span>"),a=0;a<this.data.Store.Statu;a++)d.push('<strong class="on"></strong>');for(a=0;f>a;a++)d.push("<strong></strong>");d.push("</div>"),this.$product.html(c.join("")),this.$store.html(d.join("")),this.sid=this.data.Store.Id,this.getProducts(),e&&this.initFocus()},getProducts:function(b){var c=this;a.ajax({url:apiX+"product",data:{sid:this.sid,num:6,pid:this.id},method:"get",dataType:"json",success:function(a){+a.status&&(c.products=a.data,c.createProducts())}})},createProducts:function(){var b,c,d,e=[];for(e.push("<h3><span>店铺热门商品</span></h3><ul>"),b=0,c=this.products.length;c>b;b++)d=this.products[b],e.push('<li><a href="/product.html?id='+d.Id+'"><b><img src="'+a.addThumbSuf(d.Thumb,"500_500")+'" width="100%" /></b><p>'+d.Name+"</p>"+(d.Price?"<strong>￥"+d.Price/100+"</strong>":"<span>"+priceNullWord+"</span>")+"</a></li>");e.push("</ul>"),this.$products.html(e.join(""))},initFocus:function(){},back:function(){b.history.back()||b.location.replace("/")}},a.product=function(){new f(this)}}(jQuery,window,document),function(a,b,c,d){var e=a(c),f=a.urlJson(),g=function(){this.$topbar=a(".J-x-topbar-static"),this.$span=this.$topbar.find("span"),this.$i=this.$topbar.find("i"),this.$floors=a(".J-x-floors"),this.$ul=this.$floors.find("ul"),this.$lis=this.$ul.find("li"),this.$map=a(".J-x-map"),this.$img=this.$map.find("img"),this.sid=f.sid,this.src="/images/x-floor-{floor}.png",this.ckey="xMap",this.init()};g.prototype={init:function(){this.sid?this.getData():this.selectFloor(),this.setEvents(),!a.cookie(this.ckey)&&this.guide()},getData:function(){var b=this;a.ajax({url:apiX+"store/"+this.sid,method:"get",dataType:"json",success:function(a){+a.status?(b.data=a.data,b.createStore()):b.selectFloor()},error:function(){b.selectFloor()}})},createStore:function(){var c=this;(this.$store=a('<div class="x-map-store"><a href="javascript:;" class="pack">收起</a><a href="javascript:;" class="open"><img src="'+(this.data.Logo||b.defaultStoreLogo)+'" width="92" height="92" /></a><a href="/store.html?id='+this.data.Id+'" class="store"><b><img src="'+(this.data.Logo||b.defaultStoreLogo)+'" width="120" height="120" /></b><h3>'+this.data.Name+"</h3><p>"+this.data.Sfid+"F_"+this.data.Snname.split(",")[0]+"</p></a></div>")).appendTo("body").on("click",".pack",function(){c.$store.addClass("x-map-store-packed")}).on("click",".open",function(){c.$store.removeClass("x-map-store-packed"),c.selectFloor(c._floor)}),this._floor=this.data.Sfid-1,this.selectFloor(this._floor)},selectFloor:function(a){a===d&&(a=0),this.floor!==a&&(this._floor!==d&&this._floor!==a&&this.$store.addClass("x-map-store-packed"),this.$lis.eq(this.floor||0).removeClass("active").end().eq(a).addClass("active"),this.$span.html(a+1+"F"),this.floor=a,this.showMap())},showMap:function(){var b,c,d,f=this,g=1,h=0,i=0,j=2,k=0,l=0;this.tag=1,this.$map.html(this.$img=a('<img src="'+this.src.replace("{floor}",this.floor)+'" />').animate({width:"100%",margin:"-50% 0 0 -50%"},200,function(){b=a(this),setTimeout(function(){c=b.width(),d=b.height(),f.tag=0},400)})).on("touchstart.map",function(a){if(!f.tag){var m,n,o=a.originalEvent.touches,p=o.length>1,q=o[0].pageX,r=o[0].pageY,s=0,t=0;p&&(m=q-o[1].pageX,n=r-o[1].pageY),e.on("touchmove.map",function(a){var c=a.originalEvent.touches;s=k+c[0].pageX-(p?c[1].pageX:q),t=l+c[0].pageY-(p?c[1].pageY:r),p&&(g=Math.max(Math.abs(c[0].pageX-c[1].pageX)/Math.abs(m),Math.abs(c[0].pageY-c[1].pageY)/Math.abs(n))/2),b.css({transform:"scale3d("+g+","+g+",1) translate3d("+(p?k:s)+"px,"+(p?l:t)+"px,0)"}),a.preventDefault()}).on("touchend.map touchcancel.map",function(a){p?(1>g&&(g=1),g>j&&(g=j),h=(g*c-c)/4,i=(g*d-d)/4,Math.abs(k)>h&&(k=k>=0?h:-h),Math.abs(l)>i&&(l=l>=0?i:-i)):(Math.abs(s)>h&&(s=s>=0?h:-h),Math.abs(t)>i&&(t=t>=0?i:-i),k=s,l=t),b.css({transform:"scale3d("+g+","+g+",1) translate3d("+(p?k:s)+"px,"+(p?l:t)+"px,0)"}),e.off("touchmove.map touchend.map touchcancel.map"),a.preventDefault()}),a.preventDefault()}})},setEvents:function(){function b(){d.$i.removeClass("active"),d.$ul.slideUp(function(){d.$floors.hide()})}var c,d=this;(c=function(){d.$i.hasClass("active")?(d.$floors.show(),d.$ul.slideDown()):b()})(),e.on("click",".J-x-topbar-static h1 a",function(){d.$i.toggleClass("active"),c()}).on("click",".J-x-floors ul li",function(){d.selectFloor(a(this).index())}).on("click",".J-x-floors",b)},guide:function(){var b,c=this,d=0;(this.$guide=a('<div class="x-map-guide"><a href="javascript:;">下一步</a></div>')).appendTo("body").on("click","a",function(){3>d?b():c.$guide.remove()}),(b=function(){c.$guide.removeClass("x-map-guide-0 x-map-guide-1").addClass("x-map-guide-"+d),d++,d>2&&c.$guide.find("a").html("我知道了")})(),a.cookie(this.ckey,"1")}},a.mapGuide=function(){new g}}(jQuery,window,document);